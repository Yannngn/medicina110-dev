...
<template>
  <div class="fixed inset-0 -z-10 w-full h-full bg-[var(--color-bg)]">
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" class="w-full h-full">
      <defs>
        <pattern id="customBgPattern" patternUnits="userSpaceOnUse" width="56" height="28">
          <path :fill="'var(--color-bg-secondary)'" fill-opacity="0.4"
      ...
      <rect width="100%" height="100%" fill="url(#customBgPattern)" />
    </svg>
  </div>
</template>
